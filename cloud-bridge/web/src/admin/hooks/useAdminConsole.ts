...
export function useAdminConsole() {
  ...
  return {
    ...
    connectorTokenItems: state.connectorTokenItems,
    currentDetailItems,
    currentDetailRecord,
    currentDetailTitle,
    dashboardHealthBars,
    ...
    createConnectorToken: actions.createConnectorToken,
    ...
    refreshPageData: actions.refreshPageData,
    revokeConnectorToken: actions.revokeConnectorToken,
    routeItems: state.routeItems,
    rotateConnectorToken: actions.rotateConnectorToken,
